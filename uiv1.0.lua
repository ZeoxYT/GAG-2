...
function Library:Window(Args)
    ...
    local UIGridLayout_1 = Library:Create("UIGridLayout", {
        Parent = MainTabsScrolling,
        Padding = UDim2.new(0, 10, 0, 10),
        CellSize = UDim2.new(0, 205, 0, 50),
        SortOrder = Enum.SortOrder.LayoutOrder
    })

    UIGridLayout_1:GetPropertyChangedSignal("AbsoluteContentSize"):Connect(function()
        MainTabsScrolling.CanvasSize = UDim2.new(0, 0, 0, UIGridLayout_1.AbsoluteContentSize.Y + 15)
    end)
        ...
        function Page:Slider(Args)
            ...
            local function SetDragging(state)
                ...
                if state then
                    ...
                    Library:Tween({ v = Boxvalue_1, t = 0.2, s = "Exponential", d = "Out", g = { TextColor3 = red  } }):Play()
                    Library:Tween({ v = Title_1,    t = 0.2, s = "Exponential", d = "Out", g = { TextColor3 = red  } }):Play()
                else
            ...
            do
                ...
                function Setting:AddList(Name)
                    ...
                    local function OnValue(value)
                        Title_2.TextColor3 = value and Color3.fromRGB(255, 0, 0) or Color3.fromRGB(255, 255, 255)
