...
do	
    ...
    Get2.TouchTap:Connect(function()
        setclipboard(IS_CUSTOM_UI_MODE and CUSTOM_UI_MODE_DATA.TutorialLink or 'https://zeox.xyz/tutorial')
        StarterGui:SetCore("SendNotification",{
            Title = "Key System",
            Text = "Get Key Tutorial Copied!",
